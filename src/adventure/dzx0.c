...
#define INITIAL_OFFSET 0x2000000
//#define INITIAL_OFFSET 0x1000000
//#define INITIAL_OFFSET 0x800000
...
unsigned char ip_data[BUFFER_SIZE];
unsigned char op_data[BUFFER_SIZE];
...
void save_output() {
    if (output_index != 0) {
        //printf("\n\routput_size=%lx, output_index =%lu\n",INITIAL_OFFSET+ output_size, output_index);
        memcpy(INITIAL_OFFSET+output_size, output_data, output_index);
